...
require 'nav.php';
	...
	{
		$id = $_GET['edit_id'];
		$stmt_edit = $DB_con->prepare('SELECT userName, userPass, userPic FROM users WHERE userID =:uid');
	...
	if(isset($_POST['btn_save_updates']))
	{
		...
		$userjob = $_POST['user_pas'];// user email
...
<form method="post" enctype="multipart/form-data" class="form-horizontal">
    ...
    <tr>
        ...
        <td><input class="form-control" type="text" name="user_pas" value="<?php echo $userpass; ?>" required /></td>
    </tr>
