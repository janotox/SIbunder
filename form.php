...
<div class="container">
	...
	<div class="page-header">
    	<h1 class="h2">all User. || <a class="btn btn-default" href="addnew.php"> <span class="glyphicon glyphicon-plus"></span> &nbsp; add new </a></h1> 
    </div>
...
<div class="alert alert-info">
    <strong>Website : </strong> <a href="#">bangsring.com</a>!
</div>
