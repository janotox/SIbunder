            ...
            <div class="col-xs-12">  
              <div class="box">
                <div class="box-header">
                  ...
                  <a class='pull-left btn btn-primary btn-sm' href='?view=absen&act=tambahabsen'>Tambahkan Data </a>
                  <?php } ?>
                </div><!-- /.box-header -->
                <div class="box-body">
                  ...
                  <?php 
                    ...
                    echo "<tr><td>$r[id_absensi]</td>
                      ...
                      if (isset($_GET[hapus])){
                          ...
                          echo "<script>document.location='?view=absen';</script>";
                      }
  ...
  if (isset($_POST[tambah])){
      ...
      if ($filename != ''){      
        if (move_uploaded_file($_FILES['h']['tmp_name'], $uploadfile)) {
          ...
          echo "<script>window.alert('Gagal Tambahkan Data absen.');
                      window.location='?view=absen'</script>";
        }
      }else{
        mysql_query("INSERT INTO absensi_karyawan VALUES ('$_POST[a]','$_POST[b]','$_POST[c]','$_POST[d]')");
        echo "<script>document.location='?view=absen';</script>";
    ...
    echo "<div class='col-md-12'>
              ...
              <form method='POST' class='form-horizontal' action='' enctype='multipart/form-data'>
                <div class='col-md-6'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Hadir</th>                 <td><input type='text' class='form-control' name='f'></td></tr>
					<tr><th scope='row'>Alpa</th>                 <td><input type='text' class='form-control' name='g'></td></tr>
					<tr><th scope='row'>Sakit</th>                 <td><input type='text' class='form-control' name='h'></td></tr>
					<tr><th scope='row'>Ijin</th>                 <td><input type='text' class='form-control' name='i'></td></tr>
                  </tbody>
                  </table>
                </div>
              ...
              <div class='box-footer'>
                    ...
                    <a href='?view=absen'><button class='btn btn-default pull-right'>Cancel</button></a>
      ...
      if ($filename != ''){      
        if (move_uploaded_file($_FILES['h']['tmp_name'], $uploadfile)) {
          mysql_query("UPDATE absensi_karyawan a, karyawan k SET 
            ...
            echo "<script>document.location='?view=absen&act=editabsen&id=".$_POST[id]."';</script>";
        }else{
          echo "<script>window.alert('Gagal Upload Foto .');
                      window.location='?view=absen&act=editabsen&id=".$_POST[id]."'</script>";
        }
      }else{
        mysql_query("UPDATE absensi_karyawan a, karyawan k SET
							k.nama       = '$_POST[b]',
                ...
                <div class='col-md-6'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Jam Pulang</th>                 
						...
						<tr><th scope='row'>Hadir</th>               
						<td><input type='checkbox' class='form-control' name='f' value='hadir' /> Hadir
							<input type='checkbox' class='form-control' name='g' value='alpa' /> alpa
							<input type='checkbox' class='form-control' name='h' value='sakit' /> sakit
							<input type='checkbox' class='form-control' name='i' value='izin' /> izin
						</td></tr>
                ...
                <div class='col-md-6'>
                  ...
                  <tbody>
                    ...
                    <tr><th style='background-color:#E7EAEC' width='160px' rowspan='10'>";
                        ...
                        echo "<a href='?view=absen&act=editabsen&id=$_GET[id]' class='btn btn-success btn-block'>Edit Profile</a>
                        </th>
                    </tr>
                    <tr><th width='120px' scope='row'>no</th>      	<td>$s[id_absensi]</td></tr>
					<tr><th scope='row'>Nama</th>               	<td>$s[nama] $s[tanggal]</td></tr>
					...
					<tr><th scope='row'>Hadir</th>                	<td>$s[hadir]</td></tr>
					<tr><th scope='row'>Alpa</th>                 	<td>$s[alpa]</td></tr>
					<tr><th scope='row'>Sakit</th>                	<td>$s[sakit]</td></tr>
					<tr><th scope='row'>Ijin</th>                 	<td>$s[izin]</td></tr>
